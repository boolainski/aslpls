#####################################
# sisrv.tcl by DeviL                #
# Author: DeviL support@sisrv.net   #
# WebSite: www.sisrv.net            #
# Version: v2.1 2019		    #
#####################################
####################YOU MUST EDIT THIS #################################
# Uncomment the line below if you are using registered nick for your bot 
...
if {$who == ""} {
if {![botisop $channel]} {
putserv "PRIVMSG $channel :I need to have @ to do that."
return 1
}
if {[isop $channel]} {
putserv "PRIVMSG $channel :YOU ALREADY have @ in $channel"
return 1
}
...
if {[isop $who $channel]} {
putserv "PRIVMSG $channel : $who has ALREADY @ in $channel"
return 1
} 
...
putserv "MODE $channel -o $nick"
putserv "PRIVMSG $channel :This is not fair, you think that's funny? Trying to make me deop myself ?"
return 1
}
...
stick $ban $channel
putserv "KICK $channel $who :$why (2Z14emr2a §14c®îp2T)"
...
if {[string tolower $who] == [string tolower $botnick]} {
putserv "KICK $chan $nick :hah. not funny. (2Z14emr2a §14c®îp2T)"
return 1
}
if {$who == ""} {
...
if {[matchattr $who +n]} {
putserv "KICK $chan $nick :Nganjehere provat e teperta jane te demshme :)"
return 1
}
putserv "KICK $chan $who :$why (2Z14emr2a §14c®îp2T)"
...
proc hop:pub { nick uhost hand chan text } {
 ...
 putserv "PRIVMSG $chan :Cycle Command used by $nick , Cycling (2Z14emr2a §14c®îp2T)"
 putserv "PART :$chan"
 putserv "JOIN :$chan"
...
proc hop:msg { nick uhost hand text } {
 ...
 putserv "PART :$text"
 putserv "JOIN :$text"
 putserv "PRIVMSG $text :Cycle Command was used by $nick (2Z14emr2a §14c®îp2T)"
}
...
putlog "Channel Public Commands Script loaded"
